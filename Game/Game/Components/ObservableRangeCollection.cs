...
{
    /// <summary>
    /// Represents a dynamic data collection that provides notifications when items get added, or when the whole list is refreshed.
    /// </summary>
    ...
    public class ObservableRangeCollection<T> : ObservableCollection<T>
    {
        ...
        {
            if (notificationMode != NotifyCollectionChangedAction.Remove && notificationMode !=
            ...
            RaiseChangeNotificationEvents(action: NotifyCollectionChangedAction.Remove,
                                          changedItems: changedItems);
        }

        /// <summary>
        /// Clears the current collection and replace it with the specified item.
        /// </summary>
        public void Replace(T item) => RemoveRange(new[] {item});
