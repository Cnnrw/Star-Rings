...
namespace Game.Models
{
    ...
    public class ScoreModel : BaseModel<ScoreModel>
    {
        ...
        public List<List<PlayerInfoModel>> RoundsOrderedPlayerLists { get; } = new List<List<PlayerInfoModel>>();
        ...
        [Ignore] public List<PlayerInfoModel> CharacterModelDeathList { get; set; } = new List<PlayerInfoModel>();

        // Add Monsters to the List for Score, New Round, and Easier testing
        [Ignore] public List<PlayerInfoModel> MonsterModelDeathList { get; set; } = new List<PlayerInfoModel>();

        // Add Item to the List for Score, New Round, and Easier testing
        [Ignore] public List<ItemModel> ItemModelDropList { get; set; } = new List<ItemModel>();
