...
namespace UnitTests.Models
{
    ...
    public class CharacterModelTests
    {
        ...
        public void CharacterModel_Set_Default_Should_Pass()
        {
            ...
            Assert.AreEqual("jedi.png", result.ImageURI);
            ...
            Assert.AreEqual(CharacterJobEnum.Jedi, result.Job);
        }
        ...
        public void CharacterModel_FormatOutput_Default_Should_Pass()
        {
            ...
            // Assert
            Assert.AreEqual(true, result.Contains("Crewmember"));
        }
        ...
        [Test]
        public void CharacterModel_GetAttack_Princess_Should_Pass()
        {
            // ArDefense
        ...
        [Test]
        public void CharacterModel_GetAttack_AstroDroid_Should_Pass()
        {
            // ArDefense
        ...
        [Test]
        public void CharacterModel_GetDefense_Smuggler_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel { Job = CharacterJobEnum.Smuggler };
        ...
        [Test]
        public void CharacterModel_GetDefense_AstroDroid_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel { Job = CharacterJobEnum.AstroDroid };
        ...
        [Test]
        public void CharacterModel_GetDefense_ProtocolDroid_Should_Pass()
        {
            // Arrange
            var data = new CharacterModel { Job = CharacterJobEnum.ProtocolDroid };
        ...
        [Test]
        public void CharacterModel_GetSpeed_Princess_Should_Pass()
        {
            // ArDefense
            var data = new CharacterModel { Job = CharacterJobEnum.Princess };
        ...
        [Test]
        public void CharacterModel_GetSpeed_Smuggler_Should_Pass()
        {
            // ArDefense
            var data = new CharacterModel { Job = CharacterJobEnum.Smuggler };
        ...
        [Test]
        public void CharacterModel_GetSpeed_ProtocolDroid_Should_Pass()
        {
            // ArDefense
            var data = new CharacterModel { Job = CharacterJobEnum.ProtocolDroid };
